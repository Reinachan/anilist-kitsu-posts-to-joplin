...
export type ProfileActivitiesQueryVariables = Exact<{
  id?: Maybe<Scalars['Int']>;
  page?: Maybe<Scalars['Int']>;
  perPage?: Maybe<Scalars['Int']>;
}>;
...
export type ProfileActivitiesQuery = (
  { __typename?: 'Query' }
  & { Page?: Maybe<(
    { __typename?: 'Page' }
    & { pageInfo?: Maybe<(
    ...
    )>, activities?: Maybe<Array<Maybe<{ __typename?: 'ListActivity' } | { __typename?: 'MessageActivity' } | (
      { __typename?: 'TextActivity' }
      & Pick<TextActivity, 'id' | 'type' | 'replyCount' | 'likeCount' | 'text' | 'createdAt'>
      & { user?: Maybe<(
        { __typename?: 'User' }
        & Pick<User, 'id' | 'name'>
        & { avatar?: Maybe<(
        ...
        { __typename?: 'ActivityReply' }
        & Pick<ActivityReply, 'likeCount' | 'text'>
        & { user?: Maybe<(
          { __typename?: 'User' }
          & Pick<User, 'name'>
          & { avatar?: Maybe<(
 ...
 * });
 */
export function useProfileActivitiesQuery(baseOptions?: Apollo.QueryHookOptions<ProfileActivitiesQuery, ProfileActivitiesQueryVariables>) {
        return Apollo.useQuery<ProfileActivitiesQuery, ProfileActivitiesQueryVariables>(ProfileActivitiesDocument, baseOptions);
      }
export function useProfileActivitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProfileActivitiesQuery, ProfileActivitiesQueryVariables>) {
          return Apollo.useLazyQuery<ProfileActivitiesQuery, ProfileActivitiesQueryVariables>(ProfileActivitiesDocument, baseOptions);
        }
...
export type ProfileActivitiesQueryResult = Apollo.QueryResult<ProfileActivitiesQuery, ProfileActivitiesQueryVariables>;